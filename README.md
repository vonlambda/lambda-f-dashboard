...
🔴 **3 Q4** *(Crash Risk)* · 🟠 **0 Q3** *(Rotating)* · 🟡 **5 Q2** *(Fragile)* · 🟢 **2 Q1** *(Stable)*

🌐 **Systemic Regime Score: 14/30** — 🟠 *WATCH*

🎯 **Hit rate: 1/8 resolved (12.5%)** · Resolution rate: 8/49 · 41 pending
...
|--------|-----|----|-----------|------|------|----|---|----------|--------|--------|-------|
| 🔴 Commodities | 3.48 | 29% | `▁▁▂▄▅▆▇▇█▇▆▂` | 4d* | 0.13 | 27% | 90 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-05-28 |
| 🔴 Gold | 4.00 | 92% | `▁▂▂▄▁▄█▃▁▁▄▇` | 4d* | 0.25 | 65% | 90 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-06-04 |
| 🔴 Silver | 3.97 | 96% | `▃▅█▇▄▃▄▄▁▁▃▅` | 19d* | 0.21 | 73% | 90 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-05-29 |
| 🟠 Crypto (BTC) | 3.76 | 27% | `▇▆▅▆▇█▆▄▅▃▁▁` | 10d | 0.83 | 76% | 56 | 🟢 Q1 | ELEVATED (LC) | Maintain | 2026-06-04 |
| 🔴 Ethereum | 3.90 | 32% | `▃▃▃▄▆█▆▃▃▂▁▁` | 5d* | 0.76 | 61% | 56 | 🟢 Q1 | **CRITICAL** (L) | Maintain | 2026-05-02 |
| 🟢 US Equity (SPY) | 3.74 | 48% | `█▇▆▆▅▅▅▂▁▁▁▃` | -- | 0.09 | 0% | 90 | 🟡 Q2 | Normal | Monitor | 2026-05-02 |
| 🟠 UK Equity (EWU) | 3.83 | 36% | `▆▅▁▆█▃▄▃▄▆▆▃` | 13d | 0.75 | 84% | 90 | 🟡 Q2 | ELEVATED (LC) | Monitor | 2026-06-04 |
| 🔴 🆕 Germany (EWG) | 3.97 | 79% | `▁▄▄▇▇█▆▆▅▄▃▇` | 6d* | 0.74 | 90% | 90 | 🔴 Q4 | **CRITICAL** (LC) | Reduce | 2026-06-05 |
| 🔴 Bonds | 3.70 | 18% | `▆▆▅▅▅█▇▇▆▅▃▁` | 16d* | 0.88 | 96% | 90 | 🟡 Q2 | **CRITICAL** (LC) | Monitor | 2026-05-22 |
| 🔴 Emerging Markets | 3.65 | 29% | `▄▁▁▅█▇▆▆▆▄▃▁` | 4d* | 0.51 | 40% | 90 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-05-28 |
...
| 2026-05-06 | Gold | CRITICAL | Q1 | 7.1% | _pending_ | _pending_ | _pending_ |
| 2026-05-06 | Silver | CRITICAL | Q3 | 10.9% | _pending_ | _pending_ | _pending_ |
...
**9 open · 1 TP · 7 FP · Resolved hit-rate: 12.5% · Resolution rate: 8/48**
<!-- EPISODE_LEDGER_END -->
