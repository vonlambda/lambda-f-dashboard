...
🎯 **Hit rate: 1/7 resolved (14.3%)** · Resolution rate: 7/37 · 30 pending

### Δ since yesterday

- 🔴 **Silver**: CRITICAL → CRITICAL

_Unchanged: Commodities, Gold, Crypto (BTC), Ethereum, US Equity (SPY), UK Equity (EWU), Germany (EWG), Bonds, Emerging Markets._

### Live signal table

| Market | Λ-F | Λ% | 30d Trend | Elev | Corr | C% | R | Quadrant | Regime | Action | Since |
|--------|-----|----|-----------|------|------|----|---|----------|--------|--------|-------|
| 🔴 Commodities | 3.74 | 89% | `█▅▄▃▂▁▁▂▄▅▆▇` | 7d* | 0.07 | 9% | 62 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-05-02 |
| 🔴 Gold | 3.87 | 60% | `█▃▃▃▁▃▃▄▄▃▅▄` | 4d* | 0.30 | 85% | 62 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-05-14 |
| 🔴 🆕 Silver | 3.87 | 78% | `█▂▂▄▂▁▃▇▆▃▁▁` | 20d* | 0.25 | 89% | 62 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-05-21 |
...
| 🟢 US Equity (SPY) | 3.70 | 41% | `▇█▇▆▅▇▆▅▅▄▄▁` | -- | 0.18 | 4% | 62 | 🟡 Q2 | Normal | Monitor | 2026-05-02 |
| 🔴 UK Equity (EWU) | 3.96 | 82% | `▅▁▁▃▃▆▅▁▆█▃▅` | 11d | 0.80 | 96% | 62 | 🔴 Q4 | **CRITICAL** (C) | Reduce | 2026-05-20 |
| 🔴 Germany (EWG) | 3.89 | 60% | `▅▂▂▁▁▃▅▅▇▇█▆` | 11d | 0.80 | 97% | 62 | 🟡 Q2 | **CRITICAL** (C) | Monitor | 2026-05-19 |
| 🔴 Bonds | 3.98 | 85% | `▇▆█▂▃▃▄▂▁▁▇▄` | 25d* | 0.85 | 89% | 62 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-05-20 |
| 🔴 Emerging Markets | 3.82 | 72% | `█▃▂▂▃▃▁▁▅▇▇▅` | 3d* | 0.56 | 49% | 62 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-04-28 |
...
| 2026-05-20 | Germany (EWG) | CRITICAL | Q2 | _pending_ | _pending_ | _pending_ | _pending_ |
...
**9 open · 1 TP · 6 FP · Resolved hit-rate: 14.3% · Resolution rate: 7/37**
<!-- EPISODE_LEDGER_END -->
