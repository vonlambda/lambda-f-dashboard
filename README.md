...
<!-- LAMBDA_START -->
🔴 **9 CRITICAL** · 🟠 **0 ELEVATED** · 🟢 **1 NORMAL**

🔴 **4 Q4** *(Crash Risk)* · 🟠 **0 Q3** *(Rotating)* · 🟡 **6 Q2** *(Fragile)* · 🟢 **0 Q1** *(Stable)*

🌐 **Systemic Regime Score: 18/30** — 🔴 *ELEVATED SYSTEMIC RISK*

🎯 **Hit rate: 1/7 resolved (14.3%)** · Resolution rate: 7/40 · 33 pending
...
_Unchanged: Commodities, Gold, Silver, Crypto (BTC), Ethereum, US Equity (SPY), Emerging Markets._

### Live signal table

| Market | Λ-F | Λ% | 30d Trend | Elev | Corr | C% | R | Quadrant | Regime | Action | Since |
|--------|-----|----|-----------|------|------|----|---|----------|--------|--------|-------|
| 🔴 Commodities | 3.74 | 89% | `█▅▄▃▂▁▁▂▄▅▆▇` | 7d* | 0.07 | 9% | 61 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-05-02 |
| 🔴 Gold | 3.87 | 60% | `█▃▃▃▁▃▃▄▄▃▅▄` | 4d* | 0.30 | 85% | 61 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-05-14 |
| 🔴 Silver | 3.87 | 78% | `█▂▂▄▂▁▃▇▆▃▁▁` | 20d* | 0.25 | 89% | 61 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-05-07 |
| 🔴 Crypto (BTC) | 3.84 | 43% | `▃▄▅▇▅█▃▃▂▂▁▄` | 3d* | 0.76 | 61% | 64 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-05-18 |
| 🔴 Ethereum | 3.99 | 65% | `▆▇▇█▄▅▁▁▂▂▂▆` | 13d* | 0.73 | 57% | 64 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-05-02 |
| 🟢 US Equity (SPY) | 3.70 | 41% | `▇█▇▆▅▇▆▅▅▄▄▁` | -- | 0.18 | 4% | 61 | 🟡 Q2 | Normal | Monitor | 2026-05-02 |
| 🔴 🆕 UK Equity (EWU) | 3.96 | 82% | `▅▁▁▃▃▆▅▁▆█▃▅` | 11d | 0.80 | 96% | 61 | 🔴 Q4 | **CRITICAL** (C) | Reduce | 2026-05-21 |
| 🔴 🆕 Germany (EWG) | 3.89 | 60% | `▅▂▂▁▁▃▅▅▇▇█▆` | 11d | 0.80 | 97% | 61 | 🟡 Q2 | **CRITICAL** (C) | Monitor | 2026-05-21 |
| 🔴 🆕 Bonds | 3.98 | 85% | `▇▆█▂▃▃▄▂▁▁▇▄` | 25d* | 0.85 | 89% | 61 | 🔴 Q4 | **CRITICAL** (L) | Reduce | 2026-05-21 |
| 🔴 Emerging Markets | 3.82 | 72% | `█▃▂▂▃▃▁▁▅▇▇▅` | 3d* | 0.56 | 49% | 61 | 🟡 Q2 | **CRITICAL** (L) | Monitor | 2026-04-28 |
...
|------|--------|--------|----------|---------|---------|---------|--------|
| 2026-05-21 | Bonds | Q4 | Q4 | _pending_ | _pending_ | _pending_ | _pending_ |
| 2026-05-21 | Germany (EWG) | CRITICAL | Q2 | _pending_ | _pending_ | _pending_ | _pending_ |
| 2026-05-21 | Silver | Q4 | Q4 | _pending_ | _pending_ | _pending_ | _pending_ |
| 2026-05-21 | UK Equity (EWU) | Q4 | Q4 | _pending_ | _pending_ | _pending_ | _pending_ |
...
| 2026-03-25 | UK Equity (EWU) | CRITICAL |  | 2.3% | _pending_ | _pending_ | _pending_ |
| 2026-03-21 | Gold | CRITICAL |  | 0.8% | 0.8% | _pending_ | _pending_ |
| 2026-03-20 | UK Equity (EWU) | CRITICAL |  | 0.0% | 4.7% | _pending_ | _pending_ |
| 2026-03-10 | Crypto (BTC) | CRITICAL |  | 5.7% | 5.7% | _pending_ | _pending_ |
| 2026-03-09 | Emerging Markets | CRITICAL |  | 6.3% | 6.3% | _pending_ | _pending_ |
| 2026-03-09 | Germany (EWG) | CRITICAL |  | 7.3% | 7.3% | _pending_ | _pending_ |
...
**9 open · 1 TP · 6 FP · Resolved hit-rate: 14.3% · Resolution rate: 7/40**
<!-- EPISODE_LEDGER_END -->
